...
with st.container():
    ...
    st.write ('Data is stored in the :green[MongoDB] database.')
    ...
    if Get_data or st.session_state.Get_state:
        ...
        api_version = 'v3'
        api_key = 'AIzaSyBDAtn4YWsunaxvg7uACBddzeY2VZRBXlI'
...
#SQL connection
    ...
    st.header(':green[Data Transformation]')
    st.write ('This zone transforms channel data **to :blue[MySQL] database from  :green[MongoDB] database** depending on selection')
